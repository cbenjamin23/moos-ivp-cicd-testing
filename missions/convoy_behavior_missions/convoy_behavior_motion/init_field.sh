...
#------------------------------------------------------------
vecho "Setting Convoy behavior field"

echo "x=-60,y=-80,heading=90" >  vpositions.txt
echo "x=15,y=-80,heading=90"  >> vpositions.txt

echo "abe" >  vnames.txt
echo "ben" >> vnames.txt

echo "yellow" >  vcolors.txt
echo "cyan"   >> vcolors.txt

echo "CHASER" >  vroles.txt
echo "TARGET" >> vroles.txt

echo "2.8" >  vspeeds.txt
echo "1.4" >> vspeeds.txt
