...
for ARGI; do
    ...
    if [ "${ARGI}" = "--help" -o "${ARGI}" = "-h" ]; then
        ...
        echo "  --veh_mport=N        Accepted for harness compatibility"
        echo "  --veh_pshare=N       Accepted for harness compatibility"
        echo "  --mmod=NAME          Mission modification label"
...
#------------------------------------------------------------
#  Part 6: Generate the target mission file.
#------------------------------------------------------------
...
#------------------------------------------------------------
#  Part 7: Launch the simulator test community.
#------------------------------------------------------------
vecho "Launching uSimMarineV22 test community"
