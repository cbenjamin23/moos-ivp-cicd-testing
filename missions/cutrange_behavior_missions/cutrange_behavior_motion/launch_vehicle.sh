...
COLOR="yellow"
XMODE="SIM"
START_POS="x=-40,y=-80,heading=90"
STOCK_SPD="2.4"
MAX_SPD="4.0"
VROLE="CHASER"
...
for ARGI; do
    ...
    if [ "${ARGI}" = "--help" -o "${ARGI}" = "-h" ]; then
        ...
        echo "  --vrole=<role>         CHASER or TARGET        "
        exit 0
...
nsplug meta_vehicle.bhv targ_$VNAME.bhv $NSFLAGS \
       ...
       STOCK_SPD=$STOCK_SPD         VROLE=$VROLE \
       MMOD=$MMOD

#------------------------------------------------------------
#  Part 7: Exit now if requested to only create targ files
#------------------------------------------------------------
...
#------------------------------------------------------------
#  Part 8: Launch the vehicle MOOS community
#------------------------------------------------------------
...
#------------------------------------------------------------
#  Part 9: Unless auto-launched, launch uMAC until Ctrl-C
#------------------------------------------------------------
