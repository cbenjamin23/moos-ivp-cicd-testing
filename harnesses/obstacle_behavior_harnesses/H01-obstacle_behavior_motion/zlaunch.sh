...
#------------------------------------------------------------
#   Script: zlaunch.sh
#  Harness: H01-obstacle_behavior_motion
...
get_case_config() {
    ...
    case "$CASE_NAME" in
        default_auto_request_pass) CASE_SHORE_PATCH="$HARNESS_DIR/default-auto-request-pass-shoreside.xmoos" ;;
        rng_flag_pass)
            CASE_SHORE_PATCH="$HARNESS_DIR/rng-flag-pass-shoreside.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/rng-flag-pass-vehicle.xbhv"
            ;;
        cpa_flag_pass)
            CASE_SHORE_PATCH="$HARNESS_DIR/cpa-flag-pass-shoreside.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/cpa-flag-pass-vehicle.xbhv"
            ;;
        offlane_no_engagement_pass)
            CASE_SHORE_PATCH="$HARNESS_DIR/offlane-no-engagement-pass-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/offlane-no-engagement-pass-vehicle.xmoos"
            ;;
        no_refinery_pass) CASE_VEH_BHV_PATCH="$HARNESS_DIR/no-refinery-pass-vehicle.xbhv" ;;
        two_obstacles_clean_pass)
            CASE_SHORE_PATCH="$HARNESS_DIR/two-obstacles-clean-pass-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/two-obstacles-clean-pass-vehicle.xmoos"
            CASE_VEH_FULL_LOG_PATCH="$HARNESS_DIR/two-obstacles-clean-pass-full-logging-vehicle.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/two-obstacles-clean-pass-vehicle.xbhv"
            ;;
        static_polygon_pass)
            CASE_SHORE_PATCH="$HARNESS_DIR/static-polygon-pass-shoreside.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/static-polygon-pass-vehicle.xbhv"
            ;;
        poly_alias_pass)
            CASE_SHORE_PATCH="$HARNESS_DIR/static-polygon-pass-shoreside.xmoos"
        ...
        rng_flag_no_threshold_pass)
            ...
            ;;
        avoid_disabled_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/avoid-disabled-fail-shoreside.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/avoid-disabled-fail-vehicle.xbhv"
            ;;
        bad_polygon_fail)
        ...
        bad_completed_dist_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/eval-quick-fail-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/helm-malconfig-fail-vehicle.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/bad-completed-dist-fail-vehicle.xbhv"
            ;;
        bad_min_util_cpa_dist_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/eval-quick-fail-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/helm-malconfig-fail-vehicle.xmoos"
        ...
        bad_allowable_ttc_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/eval-quick-fail-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/helm-malconfig-fail-vehicle.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/bad-allowable-ttc-fail-vehicle.xbhv"
            ;;
        bad_rng_flag_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/eval-quick-fail-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/helm-malconfig-fail-vehicle.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/bad-rng-flag-fail-vehicle.xbhv"
            ;;
        bad_cpa_flag_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/eval-quick-fail-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/helm-malconfig-fail-vehicle.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/bad-cpa-flag-fail-vehicle.xbhv"
            ;;
        bad_use_refinery_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/eval-quick-fail-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/helm-malconfig-fail-vehicle.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/bad-use-refinery-fail-vehicle.xbhv"
            ;;
        bad_pwt_grade_fail)
            CASE_SHORE_PATCH="$HARNESS_DIR/eval-quick-fail-shoreside.xmoos"
            CASE_VEH_MOOS_PATCH="$HARNESS_DIR/helm-malconfig-fail-vehicle.xmoos"
            CASE_VEH_BHV_PATCH="$HARNESS_DIR/bad-pwt-grade-fail-vehicle.xbhv"
            ;;
        *)
