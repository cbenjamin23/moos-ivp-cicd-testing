...
get_case_patch() {
    local case_name="$1"
    case "$case_name" in
        collision_event_pass) CASE_PATCH="$HARNESS_DIR/collision-event-pass-shoreside.xmoos" ;;
        near_miss_event_pass) CASE_PATCH="$HARNESS_DIR/near-miss-event-pass-shoreside.xmoos" ;;
        clear_encounter_report_pass) CASE_PATCH="$HARNESS_DIR/clear-encounter-report-pass-shoreside.xmoos" ;;
        closest_range_posts_pass) CASE_PATCH="$HARNESS_DIR/closest-range-posts-pass-shoreside.xmoos" ;;
        reset_closest_range_ever_pass) CASE_PATCH="$HARNESS_DIR/reset-closest-range-ever-pass-shoreside.xmoos" ;;
        pulse_render_false_pass) CASE_PATCH="$HARNESS_DIR/pulse-render-false-pass-shoreside.xmoos" ;;
        ignore_group_blocks_pass) CASE_PATCH="$HARNESS_DIR/ignore-group-blocks-pass-shoreside.xmoos" ;;
        reject_group_blocks_pass) CASE_PATCH="$HARNESS_DIR/reject-group-blocks-pass-shoreside.xmoos" ;;
        condition_blocks_pass) CASE_PATCH="$HARNESS_DIR/condition-blocks-pass-shoreside.xmoos" ;;
        condition_allows_pass) CASE_PATCH="$HARNESS_DIR/condition-allows-pass-shoreside.xmoos" ;;
        collision_flag_macro_pass) CASE_PATCH="$HARNESS_DIR/collision-flag-macro-pass-shoreside.xmoos" ;;
        near_miss_flag_macro_pass) CASE_PATCH="$HARNESS_DIR/near-miss-flag-macro-pass-shoreside.xmoos" ;;
        encounter_flag_density_pass) CASE_PATCH="$HARNESS_DIR/encounter-flag-density-pass-shoreside.xmoos" ;;
        outside_encounter_range_blocks_pass) CASE_PATCH="$HARNESS_DIR/outside-encounter-range-blocks-pass-shoreside.xmoos" ;;
        closest_posts_disabled_absent_pass) CASE_PATCH="$HARNESS_DIR/closest-posts-disabled-absent-pass-shoreside.xmoos" ;;
        clear_encounter_default_suppressed_pass) CASE_PATCH="$HARNESS_DIR/clear-encounter-default-suppressed-pass-shoreside.xmoos" ;;
        collision_flag_numeric_cpa_pass) CASE_PATCH="$HARNESS_DIR/collision-flag-numeric-cpa-pass-shoreside.xmoos" ;;
        encounter_rings_true_posts_pass) CASE_PATCH="$HARNESS_DIR/encounter-rings-true-posts-pass-shoreside.xmoos" ;;
        encounter_rings_false_absent_pass) CASE_PATCH="$HARNESS_DIR/encounter-rings-false-absent-pass-shoreside.xmoos" ;;
        range_normalization_params_pass) CASE_PATCH="$HARNESS_DIR/range-normalization-params-pass-shoreside.xmoos" ;;
        *) return 1 ;;
    esac
}
