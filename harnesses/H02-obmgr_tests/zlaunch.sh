...
HARNESS_DIR="${PWD}"
MISSION_DIR="${HARNESS_DIR%/harnesses/H02-obmgr_tests}/missions/obmgr_tests"
...
get_case_config() {
    ...
    if [ "$CASE_NAME" = "given_baseline_pass" ]; then
        ...
        REQUIRED_TOKEN="gen_alert=name=gen_ob_far#poly=pts={35,-2:39,-2:39,2:35,2},label=ob_far#id=ob_far"
        ...
        REQUIRED_TOKEN="gen_alert=name=gen_alert_ob_far#poly=pts={35,-2:39,-2:39,2:35,2},label=ob_far#id=ob_far"
