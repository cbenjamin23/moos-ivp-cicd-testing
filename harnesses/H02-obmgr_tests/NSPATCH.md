...
- `missions/obmgr_tests/meta_vehicle.moos`
- `missions/obmgr_tests/meta_shoreside.moos`

For each harness case, `nspatch` may generate:

- `missions/obmgr_tests/meta_vehicle.moosx`
- `missions/obmgr_tests/meta_shoreside.moosx`
- `missions/obmgr_tests/meta_vehicle.bhvx`
