...
PRESETS: dict[str, Preset] = {
    ...
    "legrun-baseline-cycle": Preset(
        source=Path("/tmp/moos-cicd-legrun-gifs/sources/legrun-baseline-cycle.mp4"),
        output=REPO_ROOT / "docs/assets/gifs/legrun-baseline-cycle.gif",
        crop_w=960,
        crop_h=540,
        x=0,
        y=0,
    ...
    "legrun-far-turn-init": Preset(
        source=Path("/tmp/moos-cicd-legrun-gifs/sources/legrun-far-turn-init.mp4"),
        output=REPO_ROOT / "docs/assets/gifs/legrun-far-turn-init.gif",
        crop_w=960,
        crop_h=540,
        x=0,
        y=0,
    ...
    "legrun-individual-turn-params": Preset(
        source=Path("/tmp/moos-cicd-legrun-gifs/sources/legrun-individual-turn-params.mp4"),
        output=REPO_ROOT / "docs/assets/gifs/legrun-individual-turn-params.gif",
        crop_w=960,
        crop_h=540,
        x=0,
        y=0,
    ...
    "zigzag-baseline-port": Preset(
        source=Path("/tmp/zigzag-gif-capture-pan40/baseline_port_first_pass.mp4"),
        output=REPO_ROOT / "docs/assets/gifs/zigzag-behavior-baseline-port.gif",
        crop_w=850,
        crop_h=478,
        x=110,
        y=0,
    ...
    "zigzag-wide-angle": Preset(
        source=Path("/tmp/zigzag-gif-capture-pan40/wide_angle_pass.mp4"),
        output=REPO_ROOT / "docs/assets/gifs/zigzag-behavior-wide-angle.gif",
        crop_w=850,
        crop_h=478,
        x=110,
        y=0,
    ...
    "zigzag-fierce-zigging": Preset(
        source=Path("/tmp/zigzag-gif-capture-pan40/fierce_zigging_pass.mp4"),
        output=REPO_ROOT / "docs/assets/gifs/zigzag-behavior-fierce-zigging.gif",
        crop_w=708,
        crop_h=398,
        x=252,
        y=136,
