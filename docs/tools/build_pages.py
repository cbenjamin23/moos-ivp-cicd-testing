    ...
    <section id="example" class="content-section">
      ...
      <div class="explain-stack">
        <article>
          ...
          <pre><code>./tests/cpp/ctests.sh --pechovar</code></pre>
          <p>Run <code>./tests/cpp/ctests.sh</code> with no family option to test everything, or use <code>--help</code> to list the available families.</p>
